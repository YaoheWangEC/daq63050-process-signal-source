...
/**
  * @brief  init dma1 channel4 for "usart4_tx"
  * @param  none
  * @retval none
  */
void wk_dma1_channel4_init(void)
{
  ...
  /* flexible function enable */
  dma_flexible_config(DMA1, FLEX_CHANNEL4, DMA_FLEXIBLE_USART4_TX);
...
/**
  * @brief  init dma1 channel5 for "usart4_rx"
  * @param  none
  * @retval none
  */
void wk_dma1_channel5_init(void)
{
  ...
  /* flexible function enable */
  dma_flexible_config(DMA1, FLEX_CHANNEL5, DMA_FLEXIBLE_USART4_RX);

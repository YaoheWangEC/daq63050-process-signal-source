...
void wk_usart4_init(void)
{
  ...
  usart_dma_transmitter_enable(USART4, TRUE);

  usart_dma_receiver_enable(USART4, TRUE);

  usart_hardware_flow_control_set(USART4, USART_HARDWARE_FLOW_NONE);

  /* enable idle interrupt */
  usart_interrupt_enable(USART4, USART_IDLE_INT, TRUE);
